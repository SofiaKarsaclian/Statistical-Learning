...
# Model training
metrics = metric_set(f_meas, precision, recall) # specify metrics
...
tune_rs %>%
  show_best("roc_auc") # best ROC value is 99.37
...
lasso_final <- last_fit(final_lasso, split = training_split)
