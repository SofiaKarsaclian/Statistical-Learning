...
tree_range = c(500, 1000) # set tree range
tree_based_levels = c(trees = 2) # and levels (how many steps in tree range)
...
xg_rs = tune_grid( # specify individual components with tune_grid
  ...
  training_folds, # different folds
...
print(select_by_pct_loss(xg_rs, metric = "f_meas", trees)) # print 'best' model F1
